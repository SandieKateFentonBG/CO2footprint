...
output_path = 'C:/Users/sfenton/Code/Repositories/CO2footprint/RESULTS/' + date + '_results/'
...
#C:\Users\sfenton\Code\Repositories\CO2footprint\SCRIPTS
#C:/Users/sfenton/Code/Repositories/CO2footprint/SCRIPTS
...
json_file = export_results_as_json(output_path, res_dict, filename=reference)
txt_file = export_results_as_text_adv(output_path, res_dict,"polynomial_exponents", "theta_opt", filename=reference)
csv_file = export_results_as_csv(output_path, res_dict, filename = reference)
#wip_csv_file = csv_into_columns(output_path + reference,output_path, reference + "_col" ) #TODO: change this
