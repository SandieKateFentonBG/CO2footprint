...
def extract_feature_df_from_dict(data_dict, feature_labels): # TODO : USELESS
...
def dataframe_from_dict_keys(dict, keys, disp=False):
    import pandas as pd
    from IPython.display import display
...
"""1"""
#df_int = extract_feature_df_from_dict(nb_dict, INT_FEATURES)
#df_str = extract_feature_df_from_dict(nb_dict, STR_FEATURES)
#df_int_sc = scale_features(df_int)
#df_y = extract_feature_df_from_dict(nb_dict, OUTPUT_NAMES)

x_qual_df, x_quant_df, y_df = extract_X_y_df_from_dict(nb_dict, STR_FEATURES, INT_FEATURES, OUTPUT_NAMES, scale_int=True)



"""2"""
"""df_int_2 = dataframe_from_dict_keys(nb_dict, INT_FEATURES, disp=False)
df_str_2 = dataframe_from_dict_keys(nb_dict, STR_FEATURES, disp=False)
df_int_sc_2 = scale_features(df_int_2)
df_y_2 = dataframe_from_dict_keys(nb_dict, OUTPUT_NAMES, disp=False)
df_x_2 = dataframe_from_dict_keys(nb_dict, FEATURES_NAMES, disp=False)
#df_x = pd.concat(df_int_2, df_str_2 )

#np.stack((df_int_2, df_str_2 ), axis = 1)
"""
